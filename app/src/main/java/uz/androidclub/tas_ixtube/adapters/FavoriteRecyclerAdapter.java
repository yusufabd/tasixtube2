...
public class FavoriteRecyclerAdapter extends RecyclerView.Adapter<FavoriteRecyclerAdapter.VideoViewHolder> implements Constants{
...
//    private OnLoadMoreListener mLoadListener;
    ...
    public FavoriteRecyclerAdapter(ArrayList<Video> mList, Context mContext, FragmentManager  fm) {
        this.mList = mList;
    ...
    public void onBindViewHolder(VideoViewHolder holder, int position) {
        ...
        holder.mMore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MoreDialogFragment dialogFragment = MoreDialogFragment.newInstance(mContext, item, Constants.LIST_TYPE_FAVORITE);
